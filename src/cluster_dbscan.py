"""Part 1 -- scale the features, then discover
classes with DBSCAN.

The k-means panel is for contrast only. It is
given the correct k and
still gets the shapes wrong: assigning each point
to its nearest centre
can only carve the plane into straight-edged
pieces.
"""
...
from pipeline_common import load_dataset, load_split_scaled, VIEW_LIM
...
fig.savefig(
    r"C:\Users\andre\PycharmProjects\classification-pipeline\figures\generated\clustered_space.pdf",
    bbox_inches="tight",
    transparent=True
)